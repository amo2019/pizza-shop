...
app.logUserOut = function (redirectUser) {
  ...
  var tokenId =
    typeof app.config.sessionToken.id == "string"
      ...
      : false;
  var email =
    typeof app.config.sessionToken.email == "object"
  ...
  if (typeof tokenString == "string") {
    try {
      ...
      if (typeof token == "object") {
        ...
        console.log("app.setLoggedInClass", app.config.sessionToken);
        app.setLoggedInClass(false);
        // app.setLoggedInClass(false);
        //***************************************************************************
      }
    } catch (e) {
      app.config.sessionToken = true;
      app.setLoggedInClass(false);
    }
  }
};
...
app.setLoggedInClass = function (add) {
  ...
  if (add) {
    ...
    target.classList.remove("loggedIn"); //0000000
  }
  //    document.getElementById("cta_green").disabled = true;
  //document.getElementById("cta_blue").disabled = true;
};
...
app.setSessionToken = function (token) {
  ...
  if (typeof token == "object") {
    ...
    app.setLoggedInClass(false); //0000000000
  }
};
...
app.loadAccountEditPage = function () {
  ...
  var id =
    typeof app.config.sessionToken.id == "string"
      ...
      : false;
  console.log(
    "app.config.sessionToken.email, id",
    app.config.sessionToken,
    app.config.sessionToken.email,
    app.config.sessionToken.id
  );
    ...
    app.client.request(
      ...
      function (statusCode, responsePayload) {
        if (statusCode == 200) {
          ...
          console.log("hiddenemailInputs", hiddenemailInputs);
        } else {
